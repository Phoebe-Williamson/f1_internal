	...
	<body>
		...
		<div class="polaroid-gallery">
				<?php
					...
					/*$query = "SELECT r.RaceID, r.RaceName, r.DateTime, r.TrackID, r.DriverID, t.Location from Race r, Track t, Driver d Where r.TrackID = t.TrackID AND r.DriverID = d.DriverID";*/
					$query = "SELECT * FROM Race, Track Where Race.TrackID = Track.TrackID";
					...
					while ($row = mysqli_fetch_assoc($result)) {
						...
						echo $row['DateTime']; /* displays date and time of race in caption area */
						echo '</div>';
						echo '</div>';
					}
				?>
