...
?>
	...
	<body>
		...
		$insert_race = "INSERT INTO Race (RaceName, DateTime, TrackID, DriverID) VALUES ('$RaceName', '$DateTime', '$TrackID', '$DriverID') ";
		
		
		// checks to see if insertion fails
		if (!mysqli_query($conn, $insert_race)) {
			echo 'Race insertion failed: ' . mysqli_error($conn);
