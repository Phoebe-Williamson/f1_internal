		...
		<div class="polaroid-gallery">
				<?php
					...
					while ($row = mysqli_fetch_assoc($result)) {
						echo '<div class="polaroid">'; // grid for each polaroid
						echo '<a class="three" href="team_profile.php?TeamID='.$row['TeamID'].'">'; /* when clicked, sends user to profile page with the teamid of team clicked*/
