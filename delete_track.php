...
?>
	...
	<?php
		...
		$delete_track = "DELETE FROM Track WHERE TrackID='$_GET[TrackID]'";
		
		// checks to see if track deletion failed
		if(!mysqli_query($conn, $delete_track)) {
			echo 'Track not deleted: '.mysqli_error($conn);
